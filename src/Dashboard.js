      ...
      return (
        <div>
          <header className='header'>
            ...
            <button className='login button-block button-light' onClick={this.clickLogin}>Login</button>
            <button className='button-block button-light' onClick={this.clickRegister}>Register</button>
          ...
          <div>
            ...
            <button className='button-block button-light' onClick={this.clickLogin}>Login to ask a question</button>
